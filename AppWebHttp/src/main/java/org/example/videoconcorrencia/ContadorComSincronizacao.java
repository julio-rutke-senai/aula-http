...
public class ContadorComSincronizacao {
    ...
    private static final Object LOCK_CONTADOR = new Object();
    ...
    public static void main(String[] args)
        ...
        if (contador == resultadoEsperado) {
            System.out.println(
                    "Resultado correto: acesso sincronizado!"
            );
        }
    }

    private static void incrementarContador() {
        synchronized (LOCK_CONTADOR) {
            contador++;
        }
    }
